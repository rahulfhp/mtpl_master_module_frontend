 ...
 *
 * This onnboarding screen dot style is in Expanding dot form.
 *
...
export default function Onboarding2() {
  ...
  const handlePageChangeNext = () => {
    if (currentPage < INTRO_DATA.length) {
  ...
  return (
    <SafeAreaView style={styles.flex}>
      ...
      <View style={styles.dotsContainer}>
        {currentPage === 0 && (
          <RoundedButton label={'skip'} onPress={handlePageChangePrev} />
        )}
        {currentPage > 0 && (
          <RoundedButton label={'previous'} onPress={handlePageChangePrev} />
        )}
